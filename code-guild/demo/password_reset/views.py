...
"""
with current development settings, the development mailserver
is run inside the virtualenv with:
python -m smtpd -n -c DebuggingServer localhost:1025
all email is sent to the console for testing and debugging
"""
